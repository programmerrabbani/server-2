	...
	var ElevateZoom = {
			init: function( options, elem ) {
				...
				$('#'+self.options.gallery + ' a').click( function(e) { 
					...
					else{self.zoomImagePre = $(this).data("public/image/");}
					self.swaptheimage($(this).data("public/image/"), self.zoomImagePre);
					return false;
				});
			...
			swapAction: function(smallimage, largeimage){
				...
				if(self.options.imageCrossfade){
					...
					if(self.options.tint && self.options.zoomType != "inner") {
						...
						//self.zoomTintImage.attr("width",elem.data("public/image/"));
					...
					if(self.options.tint) {
						...
						//self.zoomTintImage.attr('src') = elem.data("public/image/");
			...
			getGalleryList: function(){
				...
				if (self.options.gallery){ 
					...
					$('#'+self.options.gallery + ' a').each(function() {
						...
						else if($(this).data("public/image/")){
							img_src = $(this).data("public/image/");
						}			
